...
public enum HeroType {
    KNIGHT(new EntityStat(250, 18, 90, 0.13f, 1.0f), HeroHitbox.KNIGHT),
    SAMURAI(new EntityStat(180, 23, 125, 0.1f, 1.5f), HeroHitbox.SAMURAI),
    WIZARD(new EntityStat(120, 40, 100, 0.09f, 3.0f), HeroHitbox.WIZARD),
